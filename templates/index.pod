...
[[Mojolicious入門 - Perl Webフレームワーク|https://mojolicious.perlzemi.com/]]

[[Webアプリケーション開発入門 Perl+Mojolicious|https://web.perlzemi.com/]]
...
<a target="_blank" href="http://www.perlri.com/">プロのWeb開発の技術を身に着けるならPerl元気塾</a>

<a target="_blank" href="http://www.perlri.com/job">プロのWeb開発者になるための仕事の探し方・選び方</a>
