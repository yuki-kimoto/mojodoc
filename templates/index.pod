...
Perl製の素晴らしいWebフレームワーク[[Mojolicious|http://mojolicious.org]]のドキュメントの日本語です。どなたでも翻訳に参加することができますので、ぜひご協力お願いします。何かわからないことなどあれば、[[Mojolicious日本ユーザーグループ|https://groups.google.com/group/mojolicious_ja]]のメーリングリスト質問を受け付けています。
最終のドキュメントの更新は2015年4月11日でMojolicious 6.04の変更を反映しています。
もし誤字脱字や、翻訳の間違いを見つけた場合は、教えてください。
またGitHubのアカウントを持っていれば、自由に修正することができます。

=head1 Mojoliciousとは

ウェブの初期にはCGIと呼ばれるPerlの素晴らしいライブラリがありました。そのためだけにPerlを学んだ人も多くいます。言語について多くのことを知らずに始めるには十分簡単でしたし、あなたを前進させるには十分強力で、やりながら学習するにはとても面白いものでした。使われていた技術は今では時代遅れのものとなっていますが、その背後にある考え方はそうではありません。Mojoliciousは最先端技術を使って、この考え方を実装する新しい試みです。([[README]]より)
...
[[Mojolicious::Guides::Tutorial]]にあります。
...
=head2 Mojoliciousの最近の主な変更点

[[最近の主な変更点]] - 機能追加や変更点などの情報

=cut

=head2 Mojoliciousの情報など

[[Mojolicious入門 - サンプルコードによるPerl入門|http://d.hatena.ne.jp/perlcodesample/20140319/1395203665]]

[[Mojoliciousリファレンス - サンプルコードによるPerl入門|http://d.hatena.ne.jp/perlcodesample/20110402/1305602329]]

[[mojo-legacy|https://github.com/jamadam/mojo-legacy]] - MojoliciousをPerl5.8で動かすためののバックポート
